            ...
            <table class="w-full text-left border-collapse">
              <thead>
                <tr class="border-b border-neutral-100">
                  ...
                  <th class="px-2 sm:px-4 lg:px-6 py-2 sm:py-3 lg:py-4 text-[8px] sm:text-[10px] lg:text-[11px] font-bold uppercase tracking-wider opacity-40">Assign Permission</th>
              ...
              <tbody class="divide-y divide-neutral-50">
                <tr v-for="user in paginatedPendingUsers" :key="user.id" class="transition-colors hover:bg-neutral-50/50">
                  ...
                  <td class="px-2 sm:px-4 lg:px-6 py-2 sm:py-3 lg:py-4">
                    <select v-model="user.selectedPermission" class="bg-transparent border border-neutral-200 rounded px-1 sm:px-2 py-1 sm:py-1.5 text-[8px] sm:text-[10px] font-bold outline-none focus:border-red-500 transition-colors uppercase w-full">
