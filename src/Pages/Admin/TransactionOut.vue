            ...
            <table class="w-full text-left border-collapse min-w-400">
              ...
              <tbody class="divide-y divide-gray-100">
                <tr v-for="item in paginatedTransactions" :key="item.id" class="hover:bg-red-50/30 transition-colors text-[11px] font-bold uppercase tracking-tight">
                  ...
                  <td class="p-4 truncate max-w-37.5">{{ item.client }}</td>
                      ...
                      <div class="space-y-4 text-[11px] leading-relaxed font-sans">
                        <section>
                          ...
                          <ul class="space-y-0.5 text-neutral-300">
                            ...
                            <li><b class="text-white">Client Name</b> — Cannot be empty</li>
                          </ul>
                        </section>
                        ...
                        <section>
                          ...
                          <ul class="space-y-0.5 text-neutral-300">
                            <li>Quantity <span class="text-white font-bold">cannot exceed</span> available stock</li>
                            <li>System checks real-time inventory levels</li>
                          </ul>
                        </section>
    ...
    <head>
      ...
      <style>
        ...
        * {
        ...
        .header-container {
          display: flex;
          justify-content: space-between; /* Isuzu on left, MDO Group on right */
          align-items: center;
          padding-bottom: 10px;
          margin-bottom: 15px;
        ...
        /* Group for Logo and Company Name/Address */
        .header-right-group {
          display: flex;
          align-items: center;
