        ...
        <div :class="[cardClass, 'rounded-2xl border overflow-hidden relative']" :style="cardStyle">
          ...
          <div class="overflow-x-auto">
            <table class="w-full text-left border-collapse">
              ...
              <tbody :class="['divide-y', isDarkMode ? 'divide-neutral-700' : 'divide-neutral-50']">
                <tr v-for="admin in paginatedAdmins" :key="admin.id" :class="['group transition-colors', isDarkMode ? 'hover:bg-neutral-800' : 'hover:bg-red-50/30']">
                  <td class="px-6 py-5">
                    <div class="flex items-center gap-3">
                      <div :class="['w-10 h-10 rounded-full flex items-center justify-center text-white font-black text-xs uppercase', isDarkMode ? 'bg-neutral-900' : 'bg-neutral-800']">
                  ...
                  <td class="px-6 py-5">
                    <div v-if="admin.isEditing" class="flex flex-col gap-1">
                      <select v-model="admin.selectedPosition" :class="['w-full border rounded px-2 py-1 text-[10px] font-bold uppercase', isDarkMode ? 'bg-neutral-700 border-neutral-600 text-white' : 'bg-white border-gray-200 text-neutral-800']">
                        <option v-for="pos in positionOptions" :key="pos" :value="pos">{{ pos }}</option>
                      </select>
                      <select v-model="admin.selectedRole" :class="['w-full border rounded px-2 py-1 text-[10px] font-bold uppercase', isDarkMode ? 'bg-neutral-700 border-neutral-600 text-white' : 'bg-white border-gray-200 text-neutral-800']">
          ...
          <div :class="['px-8 py-5 border-t flex flex-col sm:flex-row items-center justify-between gap-4', isDarkMode ? 'bg-neutral-800 border-neutral-700' : 'bg-neutral-50 border-neutral-100']">
            ...
            <div class="flex items-center gap-2">
              <select v-model="itemsPerPage" :class="['text-[10px] font-black border rounded-lg px-2 py-1 outline-none', isDarkMode ? 'bg-neutral-700 border-neutral-600 text-white' : 'bg-white border-gray-200 text-neutral-800']">
